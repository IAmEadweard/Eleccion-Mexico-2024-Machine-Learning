...
mae_scores = {}
coeficientes = {}
eleccion = pd.DataFrame({'Año': [2024], 'Mes': [6]})
...
for candidato in candidatos:
    ...
    plt.plot(fechas_futuras, pred_linea, color=colors[candidato], alpha=0.8, label=f'{candidato} regresión')

    #Burbuja de predicción con valor
